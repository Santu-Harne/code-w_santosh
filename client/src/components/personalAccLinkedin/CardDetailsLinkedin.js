                    ...
                    <div className="left-side">
                        ...
                        <div className='nav flex-column nav-pills' id='v-pills-tab flex-column'
                            ...
                            <ul className='progress-bar'>
                                ...
                                <li className='active'>
                                    <button onClick={() => { CardDetailsLinkedin() }} className="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                        ...
                        <div className="tab-content" id="v-pills-tabContent">
                            <div className="tab-pane fade show active" id="accinfo" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                ...
                                <form className='thirdPage'>
                                    ...
                                    <div className="col-6">
                                        <NavLink to={'/BusinessDetailsLinkedin'} className="nav-link float-start mt-2 btn btn-danger text-white p-2">Back</NavLink>
                                    </div>
...
export default CardDetailsLinkedin