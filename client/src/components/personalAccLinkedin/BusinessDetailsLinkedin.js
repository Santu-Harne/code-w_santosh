                        ...
                        <div className="tab-content" id="v-pills-tabContent">
                            <div className="tab-pane fade show active" id="accinfo" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                ...
                                <form className='secondPage mt-2' >
                                    ...
                                    <div className='mb-2'>
                                        <label htmlFor="Document_Location" className="form-label">Document Upload</label>
                                        <input type="file"
                                    ...
                                    <div className="row">
                                        <div className="col-6 mt-3">
                                            <NavLink to={'/AccountInfoLinkedin'} className="nav-link float-start btn btn-danger text-white p-2">Back</NavLink>
                                        </div>
                                        <div className="col-6 mt-3">
                                            <NavLink to={'/CardDetailsLinkedin'} className="nav-link float-end btn btn-primary text-white p-2" >Next</NavLink>
                                        </div>
                                    </div>
...
export default BusinessDetailsLinkedin