                                ...
                                <form className='secondPage mt-2' >
                                    ...
                                    <div className="row">
                                        <div className="col-6 mt-3">
                                            <NavLink to={'/AccountInfoGoogle'} className="nav-link float-start btn btn-danger text-white p-2">Back</NavLink>
                                        </div>
                                        <div className="col-6 mt-3">
                                            <NavLink to={'/CardDetailsGoogle'} className="nav-link float-end btn btn-primary text-white p-2" >Next</NavLink>
                                        </div>
                                    </div>
...
export default BusinessDetailsGoogle